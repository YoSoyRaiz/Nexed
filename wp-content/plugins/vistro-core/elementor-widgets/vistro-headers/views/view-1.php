...
?>
<header class="vst-header-1-area tx-header <?php echo esc_attr($position_absolute); ?>" <?php echo esc_attr($sticky_header); ?>>
    <div class="vst-header-1-content d-flex align-items-center justify-content-between">
        ...
        <div class="vst-header-1-action d-flex align-items-center">
            ...
            <a class="h1-user-btn-1" href="<?php echo esc_url($settings['button_link']['url']); ?>">
