...
if(site_url()=="https://themexriver.com/wp/vistro" OR site_url() == 'http://localhost:10348') {
...
final class ElementHelper {
	...
	public function __construct() {
		...
		add_action( 'elementor/frontend/after_enqueue_scripts', function() {
			...
			wp_enqueue_script( 'elh-element-helper', VISTRO_CORE_URL . 'assets/js/elh-element.js', [ 'jquery' ], ELH_VERSION, true );
	...
	public function init() {
		...
		// Included all files.
		require_once VISTRO_CORE_DIR . 'inc/autoload.php';
		require_once VISTRO_CORE_DIR . 'inc/helper-functions.php';
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Vistro Core', 'element-helper' ) . '</strong>',
	...
	public function add_elementor_widget_categories( $elements_manager ) {
		...
		$categories['element-helper'] =
			[
				'title' => __( 'VISTRO CORE', 'element-helper' ),
				'icon'  => 'fa fa-plug'
			];
	...
	*/
	...
	public function init_widgets() {
		...
		if (VISTRO_CORE_WOOCOMMERCE_ACTIVED) {
